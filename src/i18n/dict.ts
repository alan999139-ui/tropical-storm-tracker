...
export const dict = {
  ...
  'storm.active': { en: 'Active', zh: '活跃', fr: 'Actif', ja: '有効' },
  'storm.weakening': { en: 'Weakening', zh: '减弱中', fr: 'Affaibli', ja: '弱体化中' },
  'storm.intensifying': { en: 'Intensifying', zh: '加强中', fr: 'Intensifiant', ja: '強化中' },
  'storm.noActive': { en: 'No Active Storms', zh: '暂无活跃风暴', fr: 'Aucune Tempête Active', ja: '有効な风暴なし' },
  'storm.currentlyQuiet': { en: 'All monitored basins are currently quiet', zh: '当前所有监测海域均无风暴活动', fr: 'Tous les bassins sont actuellement calmes', ja: 'すべての監視海域は現在静穏です' },
  'storm.browseHistory': { en: 'Browse Historical Storms', zh: '浏览历史数据', fr: 'Parcourir les Données Historiques', ja: '履歴データを探索' },
  'storm.preparednessGuide': { en: 'Preparedness Guide', zh: '防灾指南', fr: 'Guide de Préparation', ja: '防災ガイド' },
  'storm.lastUpdated': { en: 'Last updated', zh: '最后更新', fr: 'Dernière mise à jour', ja: '最終更新' },
  'storm.details': { en: 'Details →', zh: '查看详情 →', fr: 'Détails →', ja: '詳細を見る →' },
  'storm.activeCount': { en: 'Active', zh: '活跃', fr: 'Actif', ja: '有効' },
  'storm.affectedArea': { en: 'Areas at Risk', zh: '受影响区域', fr: 'Zones à Risque', ja: '影響が予想される地域' },
  // 防灾 CTA
